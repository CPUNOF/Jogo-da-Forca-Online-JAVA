...
public class GameService {
    ...
    public enum Dificuldade{
        ...
        public final int maxErros;
        Dificuldade(int erros) { this.maxErros = erros; }
    }
    ...
    public void iniciarNovoJogo(String categoria, Dificuldade dificuldade){
        this.dificuldadeAtual = dificuldade;
        
        List<Palavra> palavrasFiltradas = new ArrayList<>();
        if(categoria == null || categoria.equalsIgnoreCase("TODAS")){
            palavrasFiltradas.addAll(bancoDePalavras);
        }else{
        ...
        if(palavrasFiltradas.isEmpty()){
            logger.warning("Nenhuma palavra encontrada para a categoria: " + categoria + ". Usando Todas.");
            palavrasFiltradas.addAll(bancoDePalavras);
        }
        
        int indexSorteado = random.nextInt(palavrasFiltradas.size());
        this.palavraAtual = palavrasFiltradas.get(indexSorteado);
        ...
        logger.info(() -> "Novo Jogo Iniciado... Categoria: " + categoria +
                ", Dificuldade: " + dificuldade + ", Palavra:" + palavraAtual.getTexto());
    }
    ...
    public boolean perdeu() {
        return getNumeroErros() >= dificuldadeAtual.maxErros;
    }
