...
import br.com.breno.jogodaforca.service.GameService.Dificuldade;
...
public class GamePanel extends javax.swing.JPanel implements java.awt.event.ComponentListener {
    ...
    private GameService.Dificuldade dificuldadeAtual;
    ...
    private void initComponents() {
        ...
        jPanel1.setLayout(new java.awt.GridLayout(2, 0, 30, 0));
        ...
        panelForca.setPreferredSize(new java.awt.Dimension(100, 40));
        ...
        btnMusicaAnterior.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/anterior.png"))); // NOI18N
        btnMusicaAnterior.setMaximumSize(new java.awt.Dimension(10, 519));
        btnMusicaAnterior.setPreferredSize(new java.awt.Dimension(78, 27));
        panelMusicaControles.add(btnMusicaAnterior);
        btnMusicaAnterior.getAccessibleContext().setAccessibleName("");

        btnMusicaPlayPause.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/pausa.png"))); // NOI18N
        panelMusicaControles.add(btnMusicaPlayPause);

        btnMusicaProxima.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/proximo.png"))); // NOI18N
    ...
    public void prepararNovoJogo(String categoria, GameService.Dificuldade dificuldade) {

        this.categoriaAtual = categoria;
        this.dificuldadeAtual = dificuldade;
        gameService.iniciarNovoJogo(categoria, dificuldade);
    ...
    private void atualizarTela() {
        ...
        String erros = "Erros (" + gameService.getNumeroErros() + "/" + gameService.getDificuldadeAtual().maxErros + "): ";
    ...
    private void processarTentativa(char letra) {
        ...
        if (acertou) {
            ...
            int numErros = gameService.getNumeroErros();
            int maxErros = gameService.getDificuldadeAtual().maxErros;
            int etapaCanvas = (int) Math.round(((double) numErros / maxErros) * 8.0);
            canvas.setEtapa(etapaCanvas);
        }
        ...
        if (gameService.venceu()) {
            ...
            if (resposta == JOptionPane.YES_OPTION) {
                prepararNovoJogo(this.categoriaAtual, this.dificuldadeAtual);
            } else {
    ...
    private void finalizarPartida(String mensagemFinal, String titulo) {
        ...
        if (nome != null && !nome.isBlank()) {
            ...
            Partida partida = new Partida(
                    ...
                    this.categoriaAtual,
                    this.dificuldadeAtual.toString()
            );
