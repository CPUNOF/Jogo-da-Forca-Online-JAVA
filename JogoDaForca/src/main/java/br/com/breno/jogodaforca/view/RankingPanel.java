 ...
 */
    ...
    private void initComponents() {
        ...
        tblRanking.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "#", "Jogador", "Pontuação", "Palavras Vencidas", "Dicas Usadas", "Categoria", "Dificuldade"
            }
        ) {
        ...
        painelBotaoVoltar.setBackground(new java.awt.Color(0, 51, 0));
        painelBotaoVoltar.setForeground(new java.awt.Color(0, 51, 0));
        painelBotaoVoltar.setLayout(new java.awt.FlowLayout(java.awt.FlowLayout.RIGHT));
        ...
        add(painelBotaoVoltar, java.awt.BorderLayout.SOUTH);
    ...
    private void carregarRanking(){
        ...
        try {
            List<br.com.breno.jogodaforca.model.Partida> top25 = rankingDAO.top25();
            
            int posicao = 1;
            
            for (br.com.breno.jogodaforca.model.Partida p : top25) {
